        ...
        <div className="row">
            <div class="col">
                <div class="card border bg-dark">
                    ...
                    <p>Founded in 2023, Annapoorna offers mobile and online meal ordering capabilities to
        restaurants in thousands of cities in the India.
        Annapoorna provides digital menus on websites and in its app, from which customers
